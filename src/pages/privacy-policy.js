...
const PrivacyPolicy = () => {
  return (
    <Layout>
      ...
      <Container>
        <Paragraph>
          At APM, accessible at{" "}
          <StyledInternalLinkItem to="/">
            www.apmsoftware.co.in
        ...
        <Paragraph>Understand and analyze how you use our website</Paragraph>
        <Paragraph>
        ...
        <Heading>DoubleClick DART Cookie</Heading>
        <Paragraph>
        ...
        <Paragraph>https://policies.google.com/technologies/ads</Paragraph>
        ...
        <Heading>GDPR Privacy Policy (Data Protection Rights)</Heading>
        <Paragraph>
